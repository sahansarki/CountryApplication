...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun getDataFromSQLite() {
        ...
        tells the source Observable which thread to emit
        and push items on all the way down to Observer (hence, it affects both
        upstream and downstream operators). It does not matter where you put the
        subscribeOn() in your Observable chain of operators.

        In another word, if you don’t have observeOn, then your entire RxJava chain
         will be processed on the thread defined by subscribeOn.
         */
